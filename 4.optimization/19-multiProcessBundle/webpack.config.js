/**
 * 1. download thread-loader
 * 2. config this loader
 */
    ...
    module: {
        rules: [
            ...
            // js compatibility
            {
                ...
                use: [
                    /**
                     * multiple process bundle is used for 
                     * the task that is very time-consuming
                     * such that babel-loader
                     */
